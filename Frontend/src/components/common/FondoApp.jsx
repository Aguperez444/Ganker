function FondoApp() {
  return (
    <main className=" text-slate-100" stroke="currentColor">
      <div className="flex h-lvh w-full flex-row items-center justify-center bg-[url('/images/Fondo_con_Iconos_de_Juegos.webp')] bg-[length:100%_100%] bg-center bg-no-repeat">
