    ...
    <section className="rounded-2xl border border-white/10 bg-ganker-surface p-6 shadow-xl">
      <header className="mb-6">
        ...
        <p className="mt-1 text-sm text-ganker-muted">
          Agregá un nuevo rol para un videojuego.
        </p>
      </header>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        ...
        <div>
          <label
            ...
            className="mb-2 block text-sm font-medium text-ganker-text"
          >
            Nombre del rol <span className="text-ganker-orange">*</span>
          </label>
        ...
        <div>
          <label
            ...
            className="mb-2 block text-sm font-medium text-ganker-text"
          >
            Ícono del rol <span className="text-ganker-orange">*</span>
          </label>
        ...
        <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
          ...
          >
            {isLoading ? "REGISTRANDO..." : "REGISTRAR ROL"}
          </button>
        </div>
      </form>
    </section>
