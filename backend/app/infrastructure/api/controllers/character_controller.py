...
from app.infrastructure.api.dependencies.auth import get_current_user_id, RequireRole, require_admin
...
@router.get("/{videogame_id}", response_model=GetRanksResponse, status_code=200,dependencies=[Depends(require_admin)])
